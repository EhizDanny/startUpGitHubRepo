...
# st.subheader('Built By Gomycode Sanaith Wizard')

st.markdown("<h1 style = 'text-align: center; color: #5A96E3'>START UP COMPANY  PROJECT</h1> ", unsafe_allow_html = True)
...
st.sidebar.image('pngwing.com copy.png', caption= f'Welcome {username}')
...
# Create a tab for prediction and intepretation
